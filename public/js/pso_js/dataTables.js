    ...
    var O = function(h) {
        ...
        function Ha(a) {
            ...
            for (f = b.length; d < f; d++)
                ...
                else if (!l.sType) { g = 0; for (j = e.length; g < j; g++) { i = 0; for (h = c.length; i < h; i++) { n[i] === k && (n[i] = y(a, i, d, "type"));
                        p = e[g](n[i], a); if (!p && g !== e.length - 1) break; if ("html" === p) break } if (p) { l.sType = p; break } }
            ...
            if (b)
                for (d = b.length - 1; 0 <= d; d--) {
                    ...
                    for (g = p.length; f < g; f++)
                        if ("number" ===
                            typeof p[f] && 0 <= p[f]) { for (; l.length <= p[f];) Fa(a);
                            e(p[f], m) } else if ("number" === typeof p[f] && 0 > p[f]) e(l.length + p[f], m);
        ...
        function W(a) {
            if (h.isPlainObject(a)) { var b = {};
                h.each(a, function(a, c) { c && (b[a] = W(c)) }); return function(a, c, f, g) { var j = b[c] || b._; return j !== k ? j(a, c, f, g) : a } }
                    ...
                    if ("" !== f) {
                        ...
                        for (var i = 0, h = j.length; i < h; i++) {
                            ...
                            if (f) { j[i] = j[i].replace(ba, ""); "" !== j[i] && (a = a[j[i]]);
                                ...
                                a = "" === a ? g : g.join(a); break } else if (g) { j[i] = j[i].replace(S, "");
                                a = a[j[i]](); continue }
                            if (null === a || a[j[i]] ===
                                k) return k;
                            a = a[j[i]]
        ...
        function na(a, b, c, e) {
            var d = [],
                ...
                a = function(a) { if (c === k || c === j) g = m[j], i = h.trim(a.innerHTML), g && g._bAttrSrc ? (Q(g.mData._)(e, i), p(g.mData.sort, a), p(g.mData.type, a), p(g.mData.filter, a)) : l ? (g._setter || (g._setter = Q(g.mData)), g._setter(e, i)) : e[j] = i;
                    j++ };
            if (f)
                for (; f;) {
            ...
            if (b) {
                ...
                for (d = g.length; e < d; e++) {
                    ...
                    for (b = g[e].length; f < b; f++)
                        if (m =
                            i = 1, j[e][f] === k) { a.appendChild(g[e][f].cell); for (j[e][f] = 1; g[e + i] !== k && g[e][f].cell == g[e + i][f].cell;) j[e + i][f] = 1, i++; for (; g[e][f + m] !== k && g[e][f].cell == g[e][f + m].cell;) { for (c = 0; c < i; c++) j[e + c][f + m] = 1;
                                m++ }
        ...
        function M(a) {
            ...
            if (-1 !== h.inArray(!1, b)) C(a, !1);
                ...
                if (0 !== i.length) { f = j ? a.aoData.length : m; for (j = j ? 0 : g; j < f; j++) { var l = i[j],
                            p = a.aoData[l];
                        null === p.nTr && Ja(a, l);
                        l = p.nTr; if (0 !== d) { var n = e[c % d];
        ...
        function mb(a) {
            ...
            for (var f = a.sDom.split(""), g, j, i, m, l, p, n = 0; n < f.length; n++) {
                ...
                j = f[n];
                if ("<" == j) { i = h("<div/>")[0];
                    m = f[n + 1]; if ("'" == m || '"' == m) { l = ""; for (p = 2; f[n + p] != m;) l += f[n + p], p++; "H" == l ? l = b.sJUIHeader : "F" == l && (l = b.sJUIFooter); - 1 != l.indexOf(".") ? (m = l.split("."), i.id = m[0].substr(1, m[0].length - 1), i.className = m[1]) : "#" == l.charAt(0) ? i.id = l.substr(1, l.length - 1) : i.className = l;
                        n += p }
                    d.append(i);
                ...
                else if (0 !== o.ext.feature.length) { i = o.ext.feature;
                    p = 0; for (m = i.length; p < m; p++)
        ...
        function ra(a, b, c) {
            ...
            i = {
                data: b,
                success: function(b) { var f = b.error || b.sError;
        ...
        function tb(a) {
            ...
            e.bSort && (h.each(p, function(a, b) { k.order.push({ column: b.col, dir: b.dir });
                n("iSortCol_" + a, b.col);
                n("sSortDir_" + a, b.dir) }), n("iSortingCols", p.length));
            b = o.ext.legacy.ajax;
            return null === b ? a.sAjaxSource ? j : k : b ? j : k
        }

        function ub(a, b) { var c = b.sEcho !== k ? b.sEcho : b.draw,
                e = b.iTotalRecords !== k ? b.iTotalRecords : b.recordsTotal,
                d = b.iTotalDisplayRecords !== k ? b.iTotalDisplayRecords : b.recordsFiltered; if (c) { if (1 * c < a.iDraw) return;
                a.iDraw = 1 * c }
            oa(a);
            a._iRecordsTotal = parseInt(e, 10);
            a._iRecordsDisplay = parseInt(d, 10);
            c = sa(a, b);
            e = 0; for (d = c.length; e < d; e++) J(a, c[e]);
        ...
        function xb(a) {
            for (var b = o.ext.search, c = a.aiDisplay,
                    e, d, f = 0, g = b.length; f < g; f++) { for (var j = [], i = 0, h = c.length; i < h; i++) d = c[i], e = a.aoData[d], b[f](a, e._aFilterData, d, e._aData, i) && j.push(d);
                c.length = 0;
                c.push.apply(c, j) }
        }
        ...
        function yb(a) {
            ...
            for (f = a.aoData.length; e < f; e++)
                if (h = a.aoData[e], !h._aFilterData) { j = [];
                    d = 0; for (g = b.length; d < g; d++) c = b[d], c.bSearchable ? (i = y(a, e, d, "filter"), l[c.sType] && (i = l[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString())) : i = "", i.indexOf && -1 !== i.indexOf("&") && (wa.innerHTML = i, i = Zb ? wa.textContent : wa.innerText), i.replace && (i = i.replace(/[\r\n]/g, "")), j.push(i);
                    h._aFilterData = j;
        ...
        function sb(a) {
            ...
            f.p || (b.id = a.sTableId +
                "_paginate", a.aoDrawCallback.push({ fn: function(a) { if (e) { var b = a._iDisplayStart,
                                ...
                                h = l ? 1 : Math.ceil(m / h),
                                m = c(b, h),
                                p, l = 0; for (p = f.p.length; l < p; l++) Pa(a, "pageButton")(a, f.p[l], l, m, b, h) } else c.fnUpdate(a, d) }, sName: "pagination" }));
            return b
        }
        ...
        function Ga(a) {
            ...
            if (!p && !f && !d && j == aa(a) && j == i.length)
                ...
                Fb(a, j[0]);
                if (f) { for (n = g = 0; n < e.length; n++) k = c[e[n]], d = h(i[n]).outerWidth(), g += null === k.sWidthOrig ? d : parseInt(k.sWidth, 10) + d - h(i[n]).width();
                    j.width(s(g));
                    b.style.width = s(g) }
        ...
        function T(a) {
            ...
            for (a = 0; a < m.length; a++) { i = m[a][0];
                f = d[i].aDataSort;
                b = 0; for (c = f.length; b < c; b++) g = f[b], j = d[g].sType || "string", m[a]._idx === k && (m[a]._idx = h.inArray(m[a][1], d[g].asSorting)), e.push({ src: i, col: g, dir: m[a][1], index: m[a]._idx, type: j, formatter: o.ext.type.order[j + "-pre"] }) }
            return e
        }
        ...
        function lb(a) {
            ...
            if ("ssp" != B(a) && 0 !== m.length) {
                ...
                g === m.length ? h.sort(function(a, b) { var c, d, g, h, j = m.length,
                        i = f[a]._aSortData,
                        k = f[b]._aSortData; for (g = 0; g < j; g++)
                        if (h = m[g], c = i[h.col], d = k[h.col], c = c < d ? -1 : c > d ? 1 : 0, 0 !== c) return "asc" === h.dir ? c : -c;
                    c = e[a];
                    d = e[b]; return c < d ? -1 : c > d ? 1 : 0 }) : h.sort(function(a, b) {
        ...
        function Jb(a) { for (var b, c, e = a.aoColumns, d = T(a), a = a.oLanguage.oAria, f = 0, g = e.length; f < g; f++) { c = e[f]; var h = c.asSorting;
        ...
        function za(a) { var b = o.settings,
        ...
        function Pa(a, b) { var c = a.renderer,
                e = o.ext.renderer[b]; return h.isPlainObject(c) && c[b] ? e[c[b]] || e._ : "string" === typeof c ? e[c] || e._ : e._ }
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) R(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    if (s.length) { var u = function(a, b) { return a.getAttribute("data-" + b) !== null ? b : null };
                        h.each(na(q, s[0]).cells, function(a, b) { var c = q.aoColumns[a]; if (c.mData === a) { var e = u(b, "sort") || u(b, "order"),
                                    d = u(b, "filter") || u(b, "search"); if (e !== null || d !== null) { c.mData = { _: a + ".display", sort: e !== null ? a + ".@data-" + e : k, type: e !== null ? a + ".@data-" + e : k, filter: d !== null ? a + ".@data-" + d : k };
                                    ka(q, a) } } }) }
                    var v = q.oFeatures;
                    ...
                    xa(q);
                    v.bSort && z(q, "aoDrawCallback", function() { if (q.bSorted) { var a = T(q),
                                b = {};
                            h.each(a, function(a, c) { b[c.src] = c.dir });
                            w(q, null, "order", [q, a, b]);
                            Jb(q) } });
                    z(q, "aoDrawCallback", function() {
                        (q.bSorted || B(q) === "ssp" || v.bDeferRender) && xa(q) }, "sc");
                    gb(q);
        ...
        var Tb = [],
            v = Array.prototype,
            cc = function(a) { var b, c, e = o.settings,
        ...
        t.prototype = {
            ...
            iterator: function(a, b, c, e) {
                ...
                g = 0;
                for (h = l.length; g <
                    h; g++) { var q = new t(l[g]); if ("table" === b) f = c.call(q, l[g], g), f !== k && d.push(f);
                    else if ("columns" === b || "rows" === b) f = c.call(q, l[g], this[g], g), f !== k && d.push(f);
                    else if ("column" === b || "column-rows" === b || "row" === b || "cell" === b) { n = this[g]; "column-rows" === b && (p = Ca(l[g], o.opts));
                        i = 0; for (m = n.length; i < m; i++) f = n[i], f = "cell" === b ? c.call(q, l[g], f.row, f.column, g, i) : c.call(q, l[g], f, g, i, p), f !== k && d.push(f) } }
        ...
        t.extend = function(a, b, c) {
            if (c.length && b && (b instanceof t || b.__dt_wrapper)) {
                var e, d, f, g = function(a, b, c) { return function() { var e = b.apply(a, arguments);
                        t.extend(e, e, c.methodExt); return e } };
                e = 0;
        ...
        t.register = r = function(a, b) { if (h.isArray(a))
                ...
                for (var d = a.split("."), f = Tb, g, j, c = 0, e = d.length; c < e; c++) { g = (j = -1 !== d[c].indexOf("()")) ? d[c].replace("()", "") : d[c]; var i;
                    a: { i = 0; for (var m = f.length; i < m; i++)
        ...
        var Ub = function(a, b, c) { "ssp" == B(a) ? N(a, b) : (C(a, !0), ra(a, [], function(c) { oa(a); for (var c = sa(a, c), e = 0, g = c.length; e < g; e++) J(a, c[e]);
                N(a, b);
                C(a, !1) })); if (c) { var e = new t(a);
        ...
        var $a = function(a, b) { var c = [],
                ...
                f = 0; for (g = a.length; f < g; f++) { d = a[f] && a[f].split ? a[f].split(",") : [a[f]];
                    j = 0; for (i = d.length; j < i; j++)(e = b("string" === typeof d[j] ? h.trim(d[j]) : d[j])) && e.length && c.push.apply(c, e) } return c },
            ab = function(a) { a || (a = {});
                ...
                c = this.iterator("table", function(c) {
                    ...
                    return $a(d, function(a) {
                        ...
                        if (k) switch (k[2]) {
                            case "visIdx":
                            case "visible":
                                b = parseInt(k[1], 10); if (b < 0) { var o = h.map(g, function(a, b) { return a.bVisible ? b : null }); return [o[o.length + b]] } return [la(c, b)];
                            case "name":
                                return h.map(j, function(a, b) { return a === k[1] ? b : null }) } else return h(i).filter(a).map(function() {
        ...
        u("columns().visible()", "column().visible()", function(a, b) {
            return this.iterator("column", function(c, e) {
                ...
                if (a !== k && f.bVisible !== a) { if (a) { var l = h.inArray(!0, D(d, "bVisible"), e + 1);
                        j = 0; for (i = g.length; j < i; j++) m = g[j].nTr, d = g[j].anCells, m && m.insertBefore(d[e], d[l] || null) } else h(D(c.aoData, "anCells", e)).detach();
                    f.bVisible = a;
                    ea(c, c.aoHeader);
        ...
        r("cells()", function(a, b, c) {
            ...
            if (null === b || b === k) return this.iterator("table",
                function(b) { var e = a,
                        ...
                        m, o, r, t, s, u; return $a(e, function(a) { var c = typeof a === "function"; if (a === null || a === k || c) { m = [];
                            o = 0; for (r = g.length; o < r; o++) { i = g[o]; for (t = 0; t < l; t++) { s = { row: i, column: t }; if (c) { u = b.aoData[i];
                                        a(s, y(b, i, t), u.anCells[t]) && m.push(s) } else m.push(s) } } return m } return h.isPlainObject(a) ? [a] : j.filter(a).map(function(a, b) { i = b.parentNode._DT_RowIndex; return { row: i, column: h.inArray(b, f[i].anCells) } }).toArray() }) });
        ...
        o.versionCheck = o.fnVersionCheck = function(a) { for (var b = o.version.split("."), a = a.split("."), c, e, d = 0, f = a.length; d < f; d++)
        ...
        o.render = { number: function(a, b, c, e) { return { display: function(d) { var f = 0 > d ? "-" : "",
